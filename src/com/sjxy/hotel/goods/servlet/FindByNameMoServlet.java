...
/**
 * Servlet implementation class FindByNameMoServlet
 */
@WebServlet("/findByNameMo.do")
public class FindByNameMoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FindByNameMoServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Goods> goodsList = goodsService.findByNameMo(goodsName);
		request.setAttribute("goodsList", goodsList);
		request.setAttribute("goodsNameMo", goodsName);
