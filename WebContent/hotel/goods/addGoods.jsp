...
<body class="no-skin">
	...
	<div id="content">
		<form class="form-horizontal" role="form" action="/Hotel/addGoods.do" method="post" id="addGoodsForm">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input type="text" class="form-control" placeholder="请输入商品类别"  name="goodsType" id="goodsType">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="inputPassword" class="col-sm-2 control-label">价格</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" placeholder="请输入价格"  name="goodsPrice" id="goodsPrice">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="inputPassword" class="col-sm-2 control-label">单位</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" placeholder="请输入单位"  name="goodsUnit" id="goodsUnit">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="inputPassword" class="col-sm-2 control-label">备注</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" placeholder="请输入备注"  name="goodsNote" id="goodsNote">
		    </div>
		  </div>
