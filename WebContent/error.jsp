									...
									<div class="widget-body">
										<div class="widget-main">
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" placeholder="工号" id="login-name" name="num"/>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" class="form-control" placeholder="密码" id="login-password" name="password"/>
											...
											<div class="social-login center">
												<a href="#" style="margin-left:5px"><i class="ace-icon fa fa-weixin green"></i></a>
										...
										<div class="widget-main">
											...
											<form>
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" placeholder="工号" id="login-name"/>
															<i class="ace-icon fa fa-list-ol "></i>
														</span>
													</label>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" class="form-control" placeholder="确认密码" required="required"/>
