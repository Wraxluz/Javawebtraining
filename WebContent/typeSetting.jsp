						...
						<table id="dynamic-table"
							...
							<thead>
								<tr>
									...
									<th class="center detail-col">WIFI</th>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<div>
											<form class="no-padding" action="typeDelete" method="post"
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body no-padding">
									<tr class="detail-row">
										<form class="form-horizontal" role="form" action="typeAdd"
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" placeholder="房型" class="col-xs-8"
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" placeholder="床型" class="col-xs-8"
														required="required" name="bed" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right">
												...
												<div class="col-sm-9">
													<input type="text" placeholder="入住人数" class="col-xs-8"
														required="required" name="capability" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right">
												...
												<div class="col-sm-9">
													<input type="radio" name="WIFI" value="true" checked="true"/>有WIFI <input
														type="radio" name="WIFI" value="false" />无WIFI
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right">
												...
												<div class="col-sm-9">
													<input type="text" placeholder="房间面积" class="col-xs-8"
														required="required" name="roomsize" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right">
												...
												<div class="col-sm-9">
													<input type="text" placeholder="房价" class="col-xs-8"
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body no-padding">
									<tr class="detail-row">
										<form class="form-horizontal" role="form" action="typeChange"
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" placeholder="房型" class="col-xs-8"
														required="required" name="type"  value="<%=typelist.get(i).getType() %>"/>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" placeholder="床型" class="col-xs-8"
														required="required" name="bed" value="<%=typelist.get(i).getBed() %>"/>
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right">
												...
												<div class="col-sm-9">
													<input type="text" placeholder="入住人数" class="col-xs-8"
														required="required" name="capability" value="<%=typelist.get(i).getCapability()%>"/>
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right">
									...
									%>
									<div class="col-sm-9">
									<input type="radio" name="WIFI" value="true" checked="true"/>有WIFI 
									...
									<input type="radio" name="WIFI" value="false" checked="true"/>无WIFI
									</div>
									<%
										}
									%>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" placeholder="房间面积" class="col-xs-8"
														required="required" name="roomsize"  value="<%=typelist.get(i).getRoomsize() %>"/>
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right">
												...
												<div class="col-sm-9">
													<input type="text" placeholder="房价" class="col-xs-8"
														required="required" name="price" value="<%=typelist.get(i).getPrice() %>"/>
												</div>
											</div>
